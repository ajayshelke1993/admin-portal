...
const AUTHOR_FOOTERS = {
  'John Doe':  `<section style="margin-top:40px"><hr style="border:1px solid #ccc;margin-bottom:20px"><h3>About the Author</h3><div style="display:flex;align-items:center"><img src="https://png.pngtree.com/png-clipart/20240314/original/pngtree-handsome-cartoon-man-surprising-look-on-his-face-png-image_14584830.png" alt="John Doe" width="120" height="120" style="border-radius:50%;margin-right:20px"><div><h4>John Doe</h4><p>John Doe is the CEO of your-site. With over 35 years of experience, John is passionate about innovation and delivering top-tier customer service.</p><p>Connect: <a href="https://www.linkedin.com/" target="_blank">LinkedIn</a></p></div></div></section>`,
  'Sara Lee': `<section style="margin-top:40px"><hr style="border:1px solid #ccc;margin-bottom:20px"><h3>About the Author</h3><div style="display:flex;align-items:center"><img src="https://png.pngtree.com/png-vector/20240624/ourmid/pngtree-a-cartoon-girl-face-png-image_12840717.png" alt="Sara Lee" width="120" height="120" style="border-radius:50%;margin-right:20px"><div><h4>Sara Lee</h4><p>Sara Lee is passionate about Marketing and Sales, thriving on creating impactful strategies that engage audiences.</p><p>Connect: <a href="https://www.linkedin.com/" target="_blank">LinkedIn</a></p></div></div></section>`,
};
